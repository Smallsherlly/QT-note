...
**
** Created: Fri Aug 11 11:36:17 2017
...
static const char qt_meta_stringdata_sqlDriver[] = {
    "sqlDriver\0"
};
...
const QMetaObjectExtraData sqlDriver::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject sqlDriver::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_sqlDriver,
      qt_meta_data_sqlDriver, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &sqlDriver::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sqlDriver))
